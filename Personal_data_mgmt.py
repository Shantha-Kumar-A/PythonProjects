...
root = Tk()
root.title("Santh's Tkinter DB App")
...
# Creat Function for Edit record
def edit():
	#Create a database connection
	conn = sqlite3.connect('address_book.db')
	#Create Cursor
	...
	if len(records) > 0:
		...
		#editor.iconbitmap('baby.ico')
		editor.geometry("400x300")

		# print(records)

		#Create Global Vars for the text-box
		...
		# Create a Save button to save the edited record to DB
